...
- 二分查找的时间复杂度为：<img src="http://latex.codecogs.com/gif.latex?\  \textit{O} \left ( logn \right )" />
...
- **有序数组，<img src="http://latex.codecogs.com/gif.latex?\  \textit{O} \left ( n \right )  " />复杂度的优化一般都是往二分查找这个思路上去考虑的**
...
- 时间复杂度：<img src="http://latex.codecogs.com/gif.latex?\  \textit{O} \left ( n \right )  " />
- 空间复杂度：<img src="http://latex.codecogs.com/gif.latex?\  \textit{O} \left ( 1 \right )  " />

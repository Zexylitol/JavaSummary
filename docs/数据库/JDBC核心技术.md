...
<center><img src="https://i.im5i.com/2021/05/13/ClILs.png" alt="ClILs.png" border="0" /></center>

<center><img src="https://i.im5i.com/2021/05/13/ClivQ.png" alt="ClivQ.png" border="0" /></center>
...
- 框架=反射+注解+设计模式
- JDBC：给Java操作数据库提供一组统一的规范；（不需要关注具体的数据库厂商的细节），Java程序员只需要面向这套接口编程即可，不同的数据库厂商需要提供针对这套接口的不同实现，也即不同的数据库驱动
  - JDBC：一组API
- 反射：动态性能
- 静态代码块：随着类的加载而执行
- 怎么样让自己的代码兼容性更好、效率更高
